...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, gt_alpha_mask,
                 ...
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cuda", depth_image=None, covisibility_map=None,
                 ):
        ...
        self.covisibility_map = covisibility_map
        ...
        # Calculate intrinsics once and store
        self._intrinsics = self.calculate_intrinsics() # (3,3)
        
    def calculate_intrinsics(self):
        fx = fov2focal(self.FoVx, self.image_width) # focal_length_x
        fy = fov2focal(self.FoVy, self.image_height) # focal_length_y
        ...
        return torch.tensor(intrinsics, device=self.data_device)    
...
class PseudoCamera(nn.Module):
    def __init__(self, R, T, FoVx, FoVy, width, height, trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cuda"):
